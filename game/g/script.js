...
const batchFiles = [
  './data/g/nf_batch1.json',
  './data/g/nf_batch2.json',
  './data/g/nf_batch3.json',
  './data/g/nf_batch4.json',
  './data/g/nf_batch5.json',
  './data/g/nf_batch6.json',
  './data/g/nf_batch7.json',
  './data/g/nf_batch8.json',
  './data/g/nf_batch9.json',
  './data/g/nf_batch10.json',
];
